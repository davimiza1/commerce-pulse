...
import {
  ...
  Menu, Moon, PackageCheck, Search, Settings, ShoppingBag, Sparkles, Sun,
  TrendingUp, Users, X,
} from "lucide-react";
  ...
  return (
    <main className={dark ? "dashboard dark" : "dashboard"}>
      <aside className={sidebarOpen ? "sidebar open" : "sidebar"}>
        ...
        <div className="sidebar-bottom"><div className="upgrade"><Sparkles size={17} /><strong>Unlock deeper insights</strong><p>Connect more stores and compare performance.</p><button onClick={() => flash("Upgrade preview opened")}>View upgrade</button></div><button className={activeNav === "Settings" ? "active" : ""} onClick={() => setActiveNav("Settings")}><Settings size={17} />Settings</button><div className="profile-row"><span>MD</span><div><strong>Muhammad Dawood</strong><small>Store owner</small></div><ChevronDown size={15} /></div></div>
      </aside>
